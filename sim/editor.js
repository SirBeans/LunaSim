...
function buildTemplates() {
    ...
    function selectionAdornmentTemplate(shapeFigure = "RoundedRectangle") {
        return $(go.Adornment, "Auto",
            $(go.Shape, shapeFigure,
                {
                    fill: null,
                    stroke: "#3489eb",   // your custom highlight color
                    strokeWidth: 3
                }),
    ...
    myDiagram.nodeTemplateMap.add("stock",
        $(go.Node, nodeStyle(),
            {
                selectionAdornmentTemplate: selectionAdornmentTemplate("Rectangle")
            },
            $(go.Shape, shapeStyle(),
            ...
            $(go.Shape, shapeStyle(),
                {
                    ...
                    desiredSize: new go.Size(17, 17), // slightly bigger
                    fill: "#3489eb",
